...
export const BentoGridItem = ({
  ...
  const leftLists = ["CS Roles", "FullStack", "Typescript"];
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'rgb(0,0,0)', // Dark base color
        backgroundImage: 'linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(25,25,25,1) 49%, rgba(0,0,0,1) 91%)' // Smooth gradient overlay
      }} 
    >
      {/* add img divs */}
