...
const MagicButton = ({
  ...
  return (
    ...
    <button className="relative inline-flex h-12  overflow-hidden rounded-lg p-[2px] premium-shake focus:outline-none md:w-60 md:mt-10 shadow-[0_0_13px_#7C3AED]" onClick={handleClick || handleTrialCheckout}  disabled={isLoading} >
